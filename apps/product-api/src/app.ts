...
function httpStatus(error: ApplicationError): number {
  const statuses: Partial<Record<ApplicationError["code"], number>> = {
    ...
    REVIEWER_NOT_ALLOWED: 422,
    REVIEWER_REQUIRED: 422,
    VALIDATION_FAILED: 422,
    DELIVERABLE_NOT_FOUND: 404,
    EVIDENCE_NOT_FOUND: 404,
    DELIVERABLE_ACTION_FORBIDDEN: 403,
    DELIVERABLE_SUBMISSION_FORBIDDEN: 403,
    PM_ROLE_REQUIRED: 403,
    DELIVERABLE_ALREADY_EXISTS: 409,
    DELIVERABLE_VERSION_CONFLICT: 409,
    DELIVERABLE_ALREADY_SUBMITTED: 409,
    DELIVERABLE_NOT_SUBMITTED: 409,
    DELIVERABLE_IS_TERMINAL: 409,
    DELIVERABLE_ALREADY_ACCEPTED: 409,
    DELIVERABLE_ALREADY_WAIVED: 409,
    DELIVERABLE_SUBMIT_TRANSITION_INVALID: 409,
    DELIVERABLE_ACCEPT_TRANSITION_INVALID: 409,
    DELIVERABLE_WAIVE_TRANSITION_INVALID: 409,
    DELIVERABLE_SECURITY_OWNERSHIP_IMMUTABLE: 409,
    DELIVERABLE_RECORD_CORRUPT: 409,
    EVIDENCE_SCOPE_MISMATCH: 409,
    EVIDENCE_NOT_AVAILABLE: 409,
    PROCESS_RECORD_UNSUPPORTED: 422,
    SOURCE_TYPE_UNSUPPORTED: 422,
    INSUFFICIENT_EVIDENCE_COUNT: 422,
    DUPLICATE_EVIDENCE: 422,
    WAIVER_REASON_REQUIRED: 422,
    INVALID_DELIVERABLE_KEY: 422,
