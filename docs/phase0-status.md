...
P0-01 至 P0-05 已按依赖顺序通过。P0-05 与 P0-06 的内存实现证明逻辑契约，不预先决定生产物理存储、Task 权威或敏感 ACL。

P0-01 风险详见 `docs/reports/P0-01-source-audit.md`；部署复跑见 `docs/reports/P0-02-selfhost-replay.md`；Shell 验收见 `docs/reports/P0-04-huly-shell.md`；纵向链路见 `docs/reports/P0-05-node-task-file.md`；事件原子性见 `docs/reports/P0-06a-local-event-outbox.md`。
