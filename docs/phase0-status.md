...
| P0-07 敏感 ACL | 进行中 | `TC-SEC-001` 首根链路；`TC-SEC-002A` 新敏感后代同域继承；`TC-SEC-002B/C/D/E` 对象归属、迁移计划、非空子树 inventory 与条件换域；`TC-SEC-003A/B/C` Grant 与 Membership 原子守卫；130 项测试通过 | 迁移批次/checkpoint、真实 U2/U7/U8 模型、嵌套域及全通道 ACL |
