...
| P0-06a 本地事件与 Outbox 强化 | 探索证据已验证 | 完整事件信封、四个原子回滚断点、幂等重放/冲突、聚合版本与项目序列共 9 项测试 | P0-03 正式通过后并入 P0-06 验收 |
...
P0-03 与 P0-06a 的代码当前只是无外部依赖的预备骨架和探索证据，不能绕过 P0-01/P0-02 宣称技术闸门通过。
