...
| P0-07 敏感 ACL | 进行中 | `TC-SEC-001` 首根链路；`TC-SEC-002A` 新敏感后代同域继承；`TC-SEC-002B/C` 对象安全归属与迁移计划守卫；`TC-SEC-003A/B/C` Grant 与 Membership 原子守卫；122 项测试通过 | 真实 U2/U7/U8 模型、嵌套域及非空子树迁移、全通道 ACL |
