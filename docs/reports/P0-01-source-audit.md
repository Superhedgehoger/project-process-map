...
- 检查日期：2026-09-02
- 结论：技术证据与已知许可证风险已审阅；项目负责人于 2026-09-02 批准 P0-01 通过
...
- 已用临时、经 SHA-256 校验的 Syft 1.51.1 生成源码 SBOM和 14 个锁定部署镜像的 SBOM；另从 npm 官方注册表补取 2,887 个精确包版本的声明许可证，详见两个 SBOM 摘要与许可证摘要。
...
2. 确认部署镜像中 SSPL、AGPL/GPL/LGPL 等组件的使用与交付义务，并决定软件清单交付方式。
3. 生产发布前完成正式法务/合规复核；本次风险接受只批准继续 Phase 0 技术开发。
